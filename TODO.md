...
- Export a known-good F9P configuration file.
- Add optional external button wiring diagram.
- Add case/enclosure notes.
- Add power consumption notes.
- Add PPK processing example workflow.
